...
AFutureRacingOffroadCar::AFutureRacingOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UFutureRacingOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UFutureRacingOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UFutureRacingOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UFutureRacingOffroadWheelRear::StaticClass();
