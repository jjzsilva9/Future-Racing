...
AFutureRacingSportsCar::AFutureRacingSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UFutureRacingSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UFutureRacingSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UFutureRacingSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UFutureRacingSportsWheelRear::StaticClass();
